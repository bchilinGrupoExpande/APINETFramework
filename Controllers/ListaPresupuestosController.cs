...
{
    public class ListaPresupuestosController : BaseController
    {
        [HttpPut]
        public Reply Eliminar([FromBody] PresupuestosViewModel model)
        {
            Reply oR = new Reply();
            oR.result = 0;
            ...
            try
            {
                ...
                {
                    presupuesto oPresupuesto = db.presupuestos.Find(model.id);
                    oPresupuesto.estado = 0;
                    db.Entry(oPresupuesto).State = System.Data.Entity.EntityState.Modified;
                    db.SaveChanges();
                    oR.data = "[]";
                    oR.result = 1;
                }
